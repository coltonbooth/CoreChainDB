...
.. http:get:: /api/v1/assets/?search={search}
   ...
   **Example request**:
   ...
   .. sourcecode:: http
        ...
        GET /api/v1/assets/?search=corechaindb HTTP/1.1
        Host: example.com
...
.. http:get:: /api/v1/assets?search={search}&limit={n_documents}
   ...
   **Example request**:
   ...
   .. sourcecode:: http
    ...
    GET /api/v1/assets?search=corechaindb&limit=2 HTTP/1.1
    Host: example.com
...
.. http:get:: /api/v1/metadata/?search={search}
   ...
   **Example request**:
   ...
   .. sourcecode:: http
        ...
        GET /api/v1/metadata/?search=corechaindb HTTP/1.1
        Host: example.com
...
.. http:get:: /api/v1/metadata/?search={search}&limit={n_documents}
   ...
   **Example request**:
   ...
   .. sourcecode:: http
    ...
    GET /api/v1/metadata?search=corechaindb&limit=2 HTTP/1.1
    Host: example.com
