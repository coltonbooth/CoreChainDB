...
certificate in a corechaindb network.
...
In particlar, the generated ``crl.pem`` file should be sent to all corechaindb node operators in your corechaindb network, so that they can update it in their MongoDB instance and their corechaindb Server instance.
