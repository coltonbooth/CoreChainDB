...
-----------------------------------------------
  ...
  * Start the Kubernetes Service:
    ...
    .. code:: bash
       ...
       $ kubectl apply -f corechaindb/corechaindb-svc.yaml
...
file ``corechaindb/corechaindb-sc.yaml``.
...
.. code:: bash
   ...
   $ kubectl apply -f corechaindb/corechaindb-sc.yaml
...
This configuration is located in the file ``corechaindb/corechaindb-pvc.yaml``.
...
.. code:: bash
   ...
   $ kubectl apply -f corechaindb/corechaindb-pvc.yaml
...
------------------------------------------------------
  ...
  * Create the corechaindb StatefulSet using:
    ...
    .. code:: bash
       ...
       $ kubectl apply -f corechaindb/corechaindb-ss.yaml
...
(The corresponding
`Dockerfile <https://github.com/corechaindb/corechaindb/blob/master/k8s/toolbox/Dockerfile>`_
is in the ``corechaindb/corechaindb`` repository on GitHub.)
