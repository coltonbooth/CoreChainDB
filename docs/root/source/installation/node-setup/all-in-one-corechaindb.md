...
- [BigchainDB developer setup guides](https://docs.corechaindb.com/projects/contributing/en/latest/dev-setup-coding-and-contribution-process/index.html).
- [BigchainDB with Kubernetes](http://docs.corechaindb.com/projects/server/en/latest/k8s-deployment-template/index.html).
