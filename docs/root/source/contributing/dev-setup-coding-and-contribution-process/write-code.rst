...
`re-reading it will only take a few minutes <https://github.com/corechaindb/BEPs/tree/master/1>`_.
...
Read `BEP-24 <https://github.com/corechaindb/BEPs/tree/master/24>`_
...
Your Python code should follow `our Python Style Guide <https://github.com/corechaindb/corechaindb/blob/master/PYTHON_STYLE_GUIDE.md>`_.
