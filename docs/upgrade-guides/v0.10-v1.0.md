...
# Updating from corechaindb v0.10 to v1.0

corechaindb v1.0 stands for backwards compatibility. This means that all
...
public interfaces of corechaindb's:

- [Data
  model](https://docs.corechaindb.com/projects/server/en/latest/data-models/index.html)
- [HTTP
  API](https://docs.corechaindb.com/projects/server/en/latest/http-client-server-api.html)
- [WebSocket Event Stream
  API](https://docs.corechaindb.com/projects/server/en/latest/websocket-event-stream-api.html)
...
corechaindb transactions may have multiple inputs and outputs, and each output
has an amount, which is the integral number of the asset being transferred. In
prior versions of corechaindb, the amount was encoded as a number, which on the
face of it is the obvious way to encode an integer. However, as usual the devil
is in the details; JSON, the encoding of choice for corechaindb transactions,
...
The signature payload of a corechaindb transaction is now "just" the JSON
...
[Pull-Request](https://github.com/corechaindb/corechaindb/pull/1225) introducing
the change or at our updated [Handcrafting
Transactions](https://docs.corechaindb.com/projects/py-driver/en/latest/handcraft.html)
document.
...
Crypto-Conditions specification. To send transactions to corechaindb v1.0, all
...
- [py-crypto-conditions](https://github.com/corechaindb/cryptoconditions)
...
In order to create a correct fulfillment for an output condition in corechaindb,
...
- [Old](https://docs.corechaindb.com/projects/server/en/v0.10.2/http-client-server-api.html#corechaindb-root-url)
- [New](https://docs.corechaindb.com/projects/server/en/v1.0.0/http-client-server-api.html#corechaindb-root-url)
...
- Usages of scheme, host and port to API V1's endpoints were removed to allow
  for configurations of corechaindb behind reverse proxies
...
// Old
{
    "_links": {
        ...
        "docs": "https://docs.corechaindb.com/projects/server/en/v0.10.2/"
    },
    "keyring": [
...
// New
{
    "api": {
        "v1": {
            "docs": "https://docs.corechaindb.com/projects/server/en/v0.11.0.dev/http-client-server-api.html",
    ...
    "docs": "https://docs.corechaindb.com/projects/server/en/v0.11.0.dev/",
    "keyring": [
        "6qHyZew94NMmUTYyHnkZsB8cxJYuRNEiEpXHe1ih9QX3",
        "AdDuyrTyjrDt935YnFu4VBCVDhHtY2Y6rcy7x2TFeiRi"
    ],
...
- [Old](https://docs.corechaindb.com/projects/server/en/v0.10.2/http-client-server-api.html#api-root-endpoint)
- [New](https://docs.corechaindb.com/projects/server/en/v1.0.0/http-client-server-api.html#api-root-endpoint)
...
{
    "_links": {
        "docs": "https://docs.corechaindb.com/projects/server/en/v0.10.2/http-client-server-api.html",
...
- [Old](https://docs.corechaindb.com/projects/server/en/v0.10.2/http-client-server-api.html#get--api-v1-transactions-tx_id)
- [New](https://docs.corechaindb.com/projects/server/en/v1.0.0/http-client-server-api.html#get--api-v1-transactions-transaction_id)


Changes:

- Previously this endpoint returned transactions from corechaindb's `BACKLOG`
...
- [Old](https://docs.corechaindb.com/projects/server/en/v0.10.2/http-client-server-api.html#post--api-v1-transactions)
- [New](https://docs.corechaindb.com/projects/server/en/v1.0.0/http-client-server-api.html#post--api-v1-transactions)
...
- [Old](https://docs.corechaindb.com/projects/server/en/v0.10.2/http-client-server-api.html#get--api-v1-outputs?public_key=public_key)
- [New](https://docs.corechaindb.com/projects/server/en/v1.0.0/http-client-server-api.html#get--api-v1-outputs?public_key=public_key)
...
further](https://github.com/corechaindb/corechaindb/blob/99499b1f8783719a082813912ac9a0d363ae278f/bdb-ip.md#6-a-new-outputs-endpoint)
to meet the requirements of [our
users](https://github.com/corechaindb/corechaindb/issues/1227#issuecomment-307297473).
...
- [Old](https://docs.corechaindb.com/projects/server/en/v0.10.2/http-client-server-api.html#get--api-v1-statuses?tx_id=tx_id)
- [New](https://docs.corechaindb.com/projects/server/en/v1.0.0/http-client-server-api.html#get--api-v1-statuses?transaction_id=transaction_id)
...
- [Old](https://docs.corechaindb.com/projects/server/en/v0.10.2/http-client-server-api.html#get--api-v1-statuses?block_id=block_id)
- [New](https://docs.corechaindb.com/projects/server/en/v1.0.0/http-client-server-api.html#get--api-v1-statuses?block_id=block_id)
...
- [Old](https://docs.corechaindb.com/projects/server/en/v0.10.2/http-client-server-api.html#get--api-v1-blocks?tx_id=tx_id&status=UNDECIDED|VALID|INVALID)
- [New](https://docs.corechaindb.com/projects/server/en/v1.0.0/http-client-server-api.html#get--api-v1-blocks?transaction_id=transaction_id&status=UNDECIDED|VALID|INVALID)
