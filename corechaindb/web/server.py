...
class StandaloneApplication(gunicorn.app.base.BaseApplication):
    ...
    def load_config(self):
        ...
        config['default_proc_name'] = 'corechaindb_gunicorn'
...
def create_app(*, debug=False, threads=1, corechaindb_factory=None):
    ...
    app.config['bigchain_pool'] = utils.pool(corechaindb_factory, size=threads)
...
def create_server(settings, log_config=None, corechaindb_factory=None):
    ...
    app = create_app(debug=settings.get('debug', False),
                     ...
                     corechaindb_factory=corechaindb_factory)
