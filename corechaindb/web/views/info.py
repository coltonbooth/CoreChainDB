...
from corechaindb.web.views.base import base_ws_uri
from corechaindb import version
from corechaindb.web.websocket_server import EVENTS_ENDPOINT


class RootIndex(Resource):
    def get(self):
        docs_url = [
            'https://docs.corechaindb.com/projects/server/en/v',
            version.__version__ + '/'
        ]
