...
from corechaindb.common.exceptions import (DuplicateTransaction,
                                          UnequalValidatorSet,
                                          InvalidProposer,
                                          MultipleInputsError,
                                          InvalidPowerChange)
...
def test_upsert_validator_invalid_election_public_key(b_mock, new_validator, node_key):
    from corechaindb.common.exceptions import InvalidPublicKey
...
@patch('corechaindb.elections.election.uuid4', lambda: 'mock_uuid4')
