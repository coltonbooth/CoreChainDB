...
def test_valid_txid():
    from corechaindb.web.views.parameters import valid_txid
...
def test_valid_bool():
    from corechaindb.web.views.parameters import valid_bool
...
def test_valid_ed25519():
    from corechaindb.web.views.parameters import valid_ed25519
...
def test_valid_operation():
    from corechaindb.web.views.parameters import valid_operation
