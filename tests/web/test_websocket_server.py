...
def test_eventify_block_works_with_any_transaction():
    from corechaindb.web.websocket_server import eventify_block
    from corechaindb.common.crypto import generate_key_pair
    from corechaindb.lib import Transaction
...
async def test_bridge_sync_async_queue(loop):
    from corechaindb.web.websocket_server import _multiprocessing_to_asyncio
...
@patch('corechaindb.web.websocket_server.init_app')
...
def test_start_creates_an_event_loop(queue_mock, get_event_loop_mock,
    ...
    from corechaindb.web.websocket_server import start, _multiprocessing_to_asyncio
...
async def test_websocket_string_event(test_client, loop):
    from corechaindb.web.websocket_server import init_app, POISON_PILL, EVENTS_ENDPOINT
...
async def test_websocket_block_event(b, test_client, loop):
    from corechaindb import events
    from corechaindb.web.websocket_server import init_app, POISON_PILL, EVENTS_ENDPOINT
