...
def test_validate_tx_threshold_duplicated_pk(user_pub, user_priv,
                                             asset_definition):
    from cryptoconditions import Ed25519Sha256, ThresholdSha256
    from corechaindb.common.transaction import Input, Output, Transaction
...
def test_multiple_input_validation_of_transfer_tx(user_input, user_output,
                                                  ...
                                                  user3_priv,
                                                  asset_definition):
    from corechaindb.common.transaction import (Transaction, TransactionLink,
                                               Input, Output)
    from cryptoconditions import Ed25519Sha256
    from .utils import validate_transaction_model
...
def test_create_create_transaction_multiple_io(user_output, user2_output, user_pub,
    ...
    from corechaindb.common.transaction import Transaction, Input
