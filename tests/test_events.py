...
def test_event_handler():
    from corechaindb.events import EventTypes, Event, Exchange
...
def test_event_handler_raises_when_called_after_start():
    from corechaindb.events import Exchange, POISON_PILL
...
def test_exchange_stops_with_poison_pill():
    from corechaindb.events import EventTypes, Event, Exchange, POISON_PILL
